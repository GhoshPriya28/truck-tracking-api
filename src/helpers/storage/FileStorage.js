...
var UPLOAD_PATH = path.resolve(__dirname, '..', process.env.FILE_BASE_URL);
...
function FileStorage(opts) {
    var baseUrl = process.env.FILE_BASE_URL;
...
FileStorage.prototype._generateRandomFilename = function() {
...
// this creates a Writable stream for a filepath
FileStorage.prototype._createOutputStream = function(filepath, cb) {}

// this processes the Jimp image buffer
FileStorage.prototype._processImage = function(image, cb) {
    // create a reference for this to use in local functions
    var that = this;
